...
<body>
    ...
    <main class="front-page wrapper-type1">
        <!-- <section id="preload-sec" class="pre-load">
            <picture>
                <source media="(max-width:991px)" srcset="./assets/image/Mobile-export/Mobile-Hibiki-BG-mobile.jpg">
                <img class="bg-img" src="./assets/image/Hibiki-Pre-loading-bg.jpg" alt="">
            </picture>
            <img class="logo" src="./assets/image/hibiki-logo.svg" alt="">
            <p>Japanese Taste and quality made in local
            </p>
        </section> -->
        <section class="sec-banner">
            <img class="bg-img" src="./assets/image/Banner-bg-image.jpg" alt="">
            <div class="container1440 w-100 h-100">
                <div class="cir"></div>
                <div class="wrap flex-col">
                    <h1>ส่งต่อรสชาติ <br> ต้นตำหรับ <div></div> ในทุกจาน</h1>
                    <div class="swiper myswiper-banner">
                        <div class="swiper-wrapper">
                            <div class="swiper-slide">
                                <div class="inner-wrap flex-row item-end justify-between ">
                                    <div id="wrap-left" class="img-wrap left">
                                        <img src="./assets/image/Banner-element-01.jpg" alt="">
                                    </div>
                                    <div id="wrap-main" class="main-wrap flex-col item-center justify-start">
                                        <img src="./assets/image/Dashi-shoyu.png" alt="">
                                        <h2>Dashi shoyu</h2>
                                        <h3>ดาชิโชยุ (ซอสอเนกประสงค์)</h3>
                                    </div>
                                    <div id="wrap-right" class="img-wrap right">
                                        <img src="./assets/image/Banner-element-02.jpg" alt="">
                                    </div>
                                </div>
                            </div>
                            <div class="swiper-slide">
                        ...
                        <div class="swiper-button-next">
                            <img src="./assets/image/arrow-gold.svg" alt="">
                        </div>
        ...
        <section class="sec-intro">
            <div class="container1440 w-100">
                <div class="wrap">
                    <h2>Hibiki</h2>
                    <h3>เครื่องปรุงที่ดีต่อใจ<br>
                        และดีต่อสุขภาพ</h3>
                    <p>
                        เราถือกำเนิดขึ้นด้วยความมุ่งหวังที่อยากสร้างมื้ออาหารที่ปลอดภัยต่อทุกคน <br> ในครอบครัว
                        ใช้งานง่าย
                        และได้รสชาติที่เป็นญี่ปุ่นแท้เหมือนต้นตำรับ
                    </p>
                </div>
                <div class="swiper myswiper-intro">
                    <div class="swiper-wrapper">
                        <div class="swiper-slide">
                            <img src="./assets/image/Slide-img-01.jpg" alt="">
                        </div>
                        <div class="swiper-slide">
                            <img src="./assets/image/Slide-img-02.jpg" alt="">
                        </div>
                        <div class="swiper-slide">
                            <img src="./assets/image/Slide-img-03.jpg" alt="">
                        </div>
                        <div class="swiper-slide">
                            <img src="./assets/image/Slide-img-04.jpg" alt="">
                        </div>
                    </div>
                    <img class="abs" src="./assets/image/SeekPng4.png" alt="">
                </div>
            </div>
        </section>
        <section class="sec-product">
            <img class="texture" src="./assets/image/graphic-paper-texture-white.png" alt="">
            <div class="container1440 w-100">
                <img class="abs" src="./assets/image/SeekPng3.png" alt="">
            </div>
            <div class="container1080">
                <div class="outter-wrap">
                    <h2>seasoning</h2>
                    <h3>เราคัดสรรวัตถุดิบธรรมชาติ <br>
                        ไม่ใส่ผงชูรส หรือผงปรุงรสต่างๆ </h3>
                </div>
        ...
        <section class="sec-recipes">
            <div class="container1440 w-100">
                <div class="wrap">
                    <h2>Our Recipes</h2>
                    <div class="swiper myswiper-recipes">
                        <div class="swiper-wrapper">
                            <div class="swiper-slide">
                                <div class="outter-wrap grid2">
                                    <div class="img-wrap">
                                        <img src="./assets/image/menu-img-01.jpg" alt="">
                                    </div>
                                    <div class="inner-wrap flex-col item-center justify-between">
                                        <div>
                                            <div>Nabe (Hot Pot)</div>
                                            <div>หม้อไฟญี่ปุ่นนาเบะ</div>
                                        </div>
                                        <img src="./assets/image/Ponzu-sauce.png" alt="">
                                        <div class="black-btn flex-row item-center justify-between">ดูสูตรอาหารนี้</div>
                                    </div>
                                </div>
                            </div>
                            <div class="swiper-slide">
                                <div class="outter-wrap grid2">
                                    <div class="img-wrap">
                                        <img src="./assets/image/menu-img-02.jpg" alt="">
                                    </div>
                                    <div class="inner-wrap flex-col item-center justify-between">
                                        <div>
                                            <div>Salmon Teriyaki</div>
                                            <div>แซลมอนเทริยากิ</div>
                                        </div>
                                        <img src="./assets/image/Dashi-shoyu.png" alt="">
                                        <div class="black-btn flex-row item-center justify-between">ดูสูตรอาหารนี้
                                        </div>
                                    </div>
                                </div>
                            </div>
                            <div class="swiper-slide">
                                <div class="outter-wrap grid2">
                                    <div class="img-wrap">
                                        <img src="./assets/image/menu-img-03.jpg" alt="">
                                    </div>
                                    <div class="inner-wrap flex-col item-center justify-between">
                                        <div>
                                            <div>Salmon Teriyaki</div>
                        ...
                        <div class="swiper-button-next">
                            <img src="./assets/image/arrow-black.svg" alt="">
                        </div>
                        <div class="swiper-button-prev">
                            <img src="./assets/image/arrow-black.svg" alt="">
                        </div>
        ...
        <section class="sec-sus">
            <!-- <img class="bg-img" src="./assets/image/bg-sustain-section.jpg" alt=""> -->
            <!-- <div class="cir"></div> -->
            <div class="container1180 h-100">
                <div class="wrap grid21">
                    <div class="left flex-col justify-center">
                        <div>
                            <h2>sustainable</h2>
                            <h3>เราใส่ใจในชุมชน <br>
                                และสิ่งแวดล้อม</h3>
                        </div>
                    </div>
                    <div class="right">
                        <div class="wrapper flex-col item-center">
                            <div class="card">
                                <img src="./assets/image/sus-1.svg" alt="">
                                <h3>SUSTAINABLE <br> PACKAGING</h3>
                                <p>ผลิตภัณฑ์จาก Hibiki คำนึงถึงความ ยั่งยืนของสิ่งแวดล้อม บรรจุภัณฑ์ของ
                                    เราออกแบบให้เป็นมิตรต่อสิ่งแวดล้อมสามารถนำไปรีไซเคิลได้ 100% </p>
                            </div>
                            <div class="card">
                                <img src="./assets/image/sus-2.svg" alt="">
                                <h3>CARBON <br> REDUCTION</h3>
                                <p>เราตระหนักดีว่าทุกขั้นตอนของเราพยายามลดการปล่อยก๊าซ CO2 ในชั้นบรรยากาศ ให้น้อยที่สุด
                                    โดยรักษาความสมดุลในทุก ขั้นตอน และเก็บรักษาให้ได้ประโยชน์ที่สุด</p>
                            </div>
                            <div class="card">
                                <img src="./assets/image/sus-2.svg" alt="">
                                <h3>CARBON <br> REDUCTION</h3>
...
<script>
    var swiperban = new Swiper(".myswiper-banner", {
        speed: 1,
    ...
    swiperban.on('slideChange', function () {
        gsap.to(".main-wrap img", { opacity: 0, duration: 1, scale: 0.8 })
        gsap.to(".main-wrap h2", { opacity: 0, duration: 1, y: "50px" })
        gsap.to(".main-wrap h3", { opacity: 0, duration: 1, y: "50px" })
        gsap.to(".front-page .sec-banner .img-wrap.left", { opacity: 0, duration: 1 })
        gsap.to(".front-page .sec-banner .img-wrap.right", { opacity: 0, duration: 1 })
    });

    swiperban.on('slideChangeTransitionEnd', function () {
        gsap.to(".main-wrap img", { opacity: 1, duration: 1, scale: 1 })
        gsap.to(".main-wrap h2", { opacity: 1, duration: 1, y: "0px" })
        gsap.to(".main-wrap h3", { opacity: 1, duration: 1, y: "0px" })
        gsap.to(".front-page .sec-banner .img-wrap.left", { opacity: 1, duration: 1 })
        gsap.to(".front-page .sec-banner .img-wrap.right", { opacity: 1, duration: 1 })
    });
</script>
...
<!-- <script>
    function preload() {
        ...
        document.getElementById("preload-sec").classList.add("loaded");
    }
