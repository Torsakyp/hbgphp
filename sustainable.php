...
<body>
    ...
    <main class="sus-page wrapper-type2">
        <section class="sec-banner">
            ...
            <div class="container1320 h-100">
                <div class="outter-wrap flex-col item-start justify-center">
                    <div class="inner-wrap">
                        <h1>sustainable</h1>
                        <h2>เราใส่ใจในชุมชน <br>
                            และสิ่งแวดล้อม</h2>
                    </div>
                </div>
            </div>
        ...
        <section class="sec-content">
            ...
            <div class="container700">
                <div class="outter-wrap">
                    <h2>
                        HIBIKI เราใส่ใจในสิ่งแวดล้อม<br>
                        ด้วยแผนการจัดการเพื่อความยั่งยืน
                    </h2>
                    <div class="inner-wrap flex-col">
                        <div class="item flex-row item-center">
                            <img src="./assets/image/sus-1.svg" alt="">
                            <div class="wrap">
                                <h2>less waste</h2>
                                <p>ผลิตภัณฑ์ของเราทำจากแก้วคุณภาพดี คงทน สามารถรีไซเคิลได้ 100%
                                    ทำให้คุณเปลี่ยนจากการใช้งานพลาสติกครั้งเดียวทิ้ง
                                    เป็นการใช้งานบรรจุภัณฑ์ได้ไม่รู้จบ
                                </p>
                            </div>
                        </div>
                        <div class="item flex-row item-center">
                            ...
                            <div class="wrap">
                                ...
                                <p>เราตระหนักดีว่าทุกขั้นตอนของเราพยายามลดการปล่อยก๊าซ CO2 ในชั้นบรรยากาศ ให้น้อยที่สุด
                                    โดยรักษาความสมดุลในทุกขั้นตอน และเก็บรักษาให้ได้ประโยชน์ที่สุด
                                </p>
                            </div>
                        </div>
                        <div class="item flex-row item-center">
                            <img src="./assets/image/sus-3.svg" alt="">
                            <div class="wrap">
                                <h2>SUSTAINABLE PACKAGING</h2>
                                <p>เราพยายามออกแบบสินค้าให้รีไซเคิลได้ง่าย โดยการใช้แก้วเป็น
                                    วัตถุดิบหลักของการผลิตสินค้า เพื่อส่งเสริมการใช้ซ้ำในกระบวน
